public class FindNumber {
    ...
    private static long testThreeThreads(boolean print) {
        ...
        final int[] cnt = {0, 0, 0};
        Thread t1 = new Thread(() -> cnt[0] = findInRange(1_000_000, 2_000_000, print));
        Thread t2 = new Thread(() -> cnt[1] = findInRange(2_000_001, 3_000_000, print));
        Thread t3 = new Thread(() -> cnt[2] = findInRange(3_000_001, 4_000_000, print));
        t1.start();
        t2.start();
        t3.start();
        ...
        //complete
        System.out.println("Найдено " + (cnt[0] + cnt[1] + cnt[2]) + " чисел");
